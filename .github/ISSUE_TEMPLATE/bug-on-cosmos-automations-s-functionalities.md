---
name: Bug on cosmos-automations's functionalities
about: You are interacting with cosmos-automations, and you are getting an unexpected
  behavior, an exception, or something looks wrong.
title: ''
labels: bug
assignees: ''
...
<!-- Thank you for using Cosmos Automation by White Whale Team!
...
<!-- Please include full steps to reproduce so that we can reproduce the problem or describe the context in which the bug appeared -->

1. Rewards bot failed to claim for X chain  <!-- (see "Code sample" section below) -->
2. ... <!-- describe steps to demonstrate bug -->
3. ... <!-- for example "Query X data and get wrong values" -->
